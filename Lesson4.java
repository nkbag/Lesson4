...
public class Lesson4 {
    public static void main(String[] args) {
        ...
        while (flag) {
            ...
            System.out.println("Ввести следующую запись? Y/N");
        ...
        key.forEach(n -> System.out.println(ListFname.get(n) + " " + ListTname.get(n) + " " + ListLname.get(n) + " "
                + ListAge.get(n) + " " + ListGender.get(n)));
    }
}